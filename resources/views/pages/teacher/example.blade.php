            ...
            <tr>
                ...
                <td class="custom-column">   <ul class="list-inline m-0">
                                                <li class="list-inline-item">
                                                  <a href="{{url('studentattendance')}}">  <button class="btn btn-primary btn-sm rounded-0" type="button" data-toggle="tooltip" data-placement="top" title="Attendance"><i class="fa fa-table"></i></button></a>
                                                </li>
                                                <li class="list-inline-item">
